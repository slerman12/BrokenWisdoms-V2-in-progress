...
In a thunder, the Alder Tree says:  $\mathfrak{\color{green}\text{\color{green}Y}o{\color{green}u}'r{\color{green}e} \ \text{\color{green}w}r{\color{green}o}n{\color{green}g.}}$
