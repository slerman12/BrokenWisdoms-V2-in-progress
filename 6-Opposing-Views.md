...
Chenliang, having recognized UnifiedML impressive by itself for a PhD student's thesis—a GATO/JEPA type framework—had seen that my progress on real-time real-world RL robotics was neither essential nor applicable as a basis of critique, though served as a really amazing cherry on top of an already impactful and useful framework, and before the idea had gained popularity. The new committee had not had the chance to engage as much with what I was doing, and most of them, except Charles, had abandoned ship as soon as the ambitiousness was even begun to be unpacked.
