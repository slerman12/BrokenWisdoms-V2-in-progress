...
This is meant to show that Chenliang was very supportive about my "Bittle Bots" work, even just a couple months before the six-month review, though perhaps I disagree with their unappreciation with technical diagrams, considering them to be less "'real' art." The 4 I showed were these, my favorites being "Jungly" and "Framework," and the 4th one (that I called "Public Library") was actually also proposed by Chenliang, but earlier independent of the Art of Science Competition:
