...
- I replied to that reinstatement-mentioning email when it was sent on **10/31/2024**, that is, on my last day of being an employed PhD student, [asking for evidence for the termination reasons](3-Disproof.md#hypocrisy) and my reply was ignored. It was the last message sent between us, prior to [one more](https://github.com/slerman12/BrokenWisdoms/blob/main/7-Ongoing.md) above that I resumed also currently being ignored. In the [above email](#email-02072024) (the latest of the ignored), I brought up that the reinstatement-condition wasn't indicated to me.
