...
As of 12/04/2024, I have found page 15 removed from [their current copy of the PhD student handbook](https://www.cs.rochester.edu/graduate/csgraduate-student-handbookrevformatoct24.pdf), and no mention of reinstatement clause, and suspiciously page 12 is modified rather specifically<!-- pertaining to my case-->. I've [attached the copy of the PhD student handbook from before](https://github.com/slerman12/BrokenWisdoms-V2-in-progress/blob/Ancillary/2023-v2_4-25-23_phd-handbook.pdf) in this repo (one has to press the download button in order to open it, since GitHub doesn't display long PDFs), as well as saved the current version that skips page 15, from page 14 to page 16, that I'll [attach](https://github.com/slerman12/BrokenWisdoms-V2-in-progress/blob/Ancillary/csgraduate-student-handbookrevformatoct24-12-04-2024.pdf) in this repo as well. 
