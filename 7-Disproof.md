...
Any appearance of the below email as indicating a reinstatement-condition is gaslighting. The referent of what is mentioned is reinstatement, not a reinstatement-condition. Even if that weren't the case, "in writing" cannot be relegated as "in person" (and thereby "off the record")<!-- unless the indicated reinstatement-condition can redefine the clause from which it's necessitated, but the PhD student handbook isn't a rewritable Turing tape (at least not ad lib), making that absurd to such a point that asserting it becomes the biggest defiance to the PhD student handbook possible-->.
...
Their alleged reason for terminating me was that I violated <!--a policy in--> the PhD student handbook. Here is a proof, derived mathematically, that they have violated and are currently violating <!--a policy in--> the PhD student handbook. Of course, whether I did, is still a question, since I notified the faculty in advance with extremely good cause that I wouldn't attend the make-up review and they didn't reply.

#

As of 12/04/2024, I have found page 15 removed from [their current copy of the PhD student handbook](https://www.cs.rochester.edu/graduate/csgraduate-student-handbookrevformatoct24.pdf), and no mention of reinstatement clause, and suspiciously page 12 is modified rather specifically. I've [attached the copy of the PhD student handbook from before](https://github.com/slerman12/BrokenWisdoms-V2-in-progress/blob/Ancillary/2023-v2_4-25-23_phd-handbook.pdf) in this repo (one has to press the download button in order to open it), as well as saved the current version that skips page 15, from page 14 to page 16, that I'll [attach](https://github.com/slerman12/BrokenWisdoms-V2-in-progress/blob/Ancillary/csgraduate-student-handbookrevformatoct24-12-04-2024.pdf) in this repo as well. 

It's very odd, and almost extremely on the nose, that page 15 is ripped out, with even the numbering going from 14 to 16.

<!--(In cases when GitHub doesn't display long PDFs, I have to press the download button to open).-->

I also took videos on my laptop (from my phone) of getting to their current version of the PhD student handbook from Google and Bing, and the contents, including the numeric inconsistency.

#### (3) PhD student handbook.

“When withdrawing support, the faculty will indicate to the student, in writing, what is necessary for reinstatement of support.” - [PhD student handbook](https://github.com/slerman12/BrokenWisdoms-V2-in-progress/blob/Ancillary/2023-v2_4-25-23_phd-handbook.pdf), page 15.

I wasn't going to call for their termination, but if they have fabricated their policy, then I call for their termination.
